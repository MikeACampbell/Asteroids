...
private:
   ...
   static const float xMin = -256; // minimum extent of the x position
   static const float xMax =  256; // maximum extent of the x position
   static const float yMin = -256; // minimum extent of the y position
   static const float yMax =  256; // maximum extent of the y position
};
